...
export default function HeroProfile() {
    ...
    return (
        <section id="hero" ref={containerRef} className="relative min-h-screen overflow-x-clip">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-12 md:h-20 bg-gradient-to-r from-neon-cyan/5 via-neon-red/10 to-neon-cyan/5 -skew-y-1 origin-left" />
            <div className="absolute bottom-2 md:bottom-3 left-0 right-0 h-0.5 md:h-1 bg-gradient-to-r from-neon-cyan via-neon-red to-neon-cyan -skew-y-1 origin-left"
                style={{ boxShadow: "0 0 20px rgba(0,255,255,0.5), 0 0 40px rgba(255,0,85,0.3)" }} />
        </section >
    );
}
